...
namespace Rock.Communication.Transport
{
    ...
    /// </summary>
    [Description( "Test Push which doesn't do anything except implement IRockMobilePush This shouldn't get checked in." )]
    [Export( typeof( TransportComponent ) )]
    [ExportMetadata( "ComponentName", "Push" )]
    ...
    public class Push : SMTPComponent, IRockMobilePush
    {
        /// <summary>
        /// Gets the username.
        /// </summary>
